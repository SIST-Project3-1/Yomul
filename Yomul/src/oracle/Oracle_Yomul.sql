-- 제약 조건 명명 규칙
-- '제약조건 축약어'_'자기테이블 축약어'_'상대테이블 축약어'[_속성명]
...
CREATE TABLE YOMUL_FAVORITE_LISTS(
  EMAIL VARCHAR2(100) CONSTRAINT NN_Y_FL_EMAIL NOT NULL, -- 찜한 유저
  PRODUCT_NO VARCHAR2(10) CONSTRAINT NN_Y_FL_PRODUCT_NO NOT NULL, -- 찜 된 물건
  CONSTRAINT FK_Y_FL_M_EMAIL FOREIGN KEY (EMAIL) REFERENCES YOMUL_MEMBERS(EMAIL),
  CONSTRAINT FK_Y_FL_P_NO FOREIGN KEY (PRODUCT_NO) REFERENCES YOMUL_PRODUCTS(NO)
);
...
CREATE TABLE YOMUL_CHATS(
    ...
    CHAT_FROM VARCHAR2(100) CONSTRAINT NN_Y_C_CHAT_FROM NOT NULL, -- 채팅 발신자
