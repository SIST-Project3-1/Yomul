...
INSERT INTO YOMUL_NEAR_ARTICLES(NO, WRITER,WRITER_NICKNAME , TITLE, CATEGORY, PRICE, HP, CONTENT, CHATCHECK) VALUES('n' || YOMUL_NEAR_ARTICLES_NO_SEQ.NEXTVAL, 'M1','도배맨' , '도배를 해야할까요...', '중고차', 0, '010-2724-1652', '벽걸이 에어컨하다가 뗏은데 저렇게 다 벗겨져서요 액자같은거두면 괜찮을까요? 복층집이에요 이층이고어떤액자가 좋을까요', 1);
