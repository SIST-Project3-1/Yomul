...
CREATE TABLE YOMUL_VENDORS(
    ...
    IMG VARCHAR2(200) DEFAULT '이미지준비중.jpg', --프로필 이미지
...
-- QNA 목록 불러오기
SELECT * FROM YOMUL_QNA_ARTICLES ORDER BY WDATE DESC;   
...
-- 테스트용 공지사항 파일 추가
INSERT INTO YOMUL_FILES(ARTICLE_NO, NO, FILENAME) VALUES('N1', YOMUL_NOTICES_NO_SEQ.NEXTVAL, '이미지준비중.jpg');
