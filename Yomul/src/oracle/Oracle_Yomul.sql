...
CREATE TABLE YOMUL_VENDOR_NEWS(
	...
	ARTICLE_NO VARCHAR2(10) CONSTRAINT NN_Y_VN_ARTICLE_NO NOT NULL, -- 게시글 번호
    CONSTRAINT FK_Y_VN_VENDOR_NO FOREIGN KEY (VENDOR_NO) REFERENCES YOMUL_VENDORS(NO),
	CONSTRAINT FK_Y_VN_ARTICLE_NO FOREIGN KEY (ARTICLE_NO) REFERENCES YOMUL_NEAR_ARTICLES(NO)
);
