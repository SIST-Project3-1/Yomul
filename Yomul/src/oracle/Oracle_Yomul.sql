...
CREATE TABLE YOMUL_MEMBERS(
    ...
    SUBSCRIBE VARCHAR2(3) DEFAULT 0 CONSTRAINT NN_Y_M_SUBSCRIBE NOT NULL CONSTRAINT C_Y_M_SUBSCRIBE CHECK (SUBSCRIBE IN ('on', 'off')), -- 구독, OFF: 구독안함, ON: 구독함
...
-- 회원가입, 기본 비밀번호 '1234'
INSERT INTO YOMUL_MEMBERS(NO, EMAIL, PW, NICKNAME, HASHSALT, SUBSCRIBE) VALUES('M'||YOMUL_MEMBERS_NO_SEQ.NEXTVAL, 'dia_changmin@naver.com', 'LVQl5RjTdqE2oRywog3zjhXWnZfrI4La7JlTn7orAE4=', 'Hwisaek', 'dsRPWSbFjBtmiscPw4mbph/RX9dvyI15OLs8Pq+JTKU=', 'on');

-- 프로필 정보 가져오기
SELECT NICKNAME, INTRO FROM YOMUL_MEMBERS WHERE NO = 'M1';
