...
SELECT COUNT(*) FROM YOMUL_TRADE_HISTORY WHERE BUYER = 'M1'; -- 구매 내역 수
SELECT COUNT(*) FROM YOMUL_FAVORITE_LISTS WHERE MEMBER_NO = 'M1'; -- 찜 목록 수

-- 프로필 정보 수정
UPDATE YOMUL_MEMBERS SET NICKNAME = 'Hwisaek2', PHONE = '010-1234-1234', GENDER = 'M', INTRO = '안녕하세요. 저는 Hwisaek2 입니다.' WHERE NO = 'M1'; -- 프로필 정보 수정
MERGE INTO YOMUL_FILES USING DUAL ON (ARTICLE_NO = 'M1') -- 프로필 사진 수정 
  WHEN MATCHED THEN -- 프로필 사진이 존재하면 실행 
    UPDATE SET FILENAME = '신발사진1.jpg' WHERE ARTICLE_NO = 'M1'
  WHEN NOT MATCHED THEN -- 프로필 사진이 존재하지 않으면 실행
    INSERT (ARTICLE_NO, NO, FILENAME) VALUES('M1', YOMUL_FILES_NO_SEQ.NEXTVAL, '신발사진1.jpg');
...
DESC YOMUL_FAQ_ARTICLES;

-- FAQ 데이터 생성
INSERT INTO YOMUL_FAQ_ARTICLES(NO, CATEGORY, TITLE, CONTENT) VALUES(YOMUL_FAQ_ARTICLES_NO_SEQ.NEXTVAL, 1, '제목1', '내용111');
INSERT INTO YOMUL_FAQ_ARTICLES(NO, CATEGORY, TITLE, CONTENT) VALUES(YOMUL_FAQ_ARTICLES_NO_SEQ.NEXTVAL, 2, '제목2', '내용112');
INSERT INTO YOMUL_FAQ_ARTICLES(NO, CATEGORY, TITLE, CONTENT) VALUES(YOMUL_FAQ_ARTICLES_NO_SEQ.NEXTVAL, 3, '제목3', '내용113');
INSERT INTO YOMUL_FAQ_ARTICLES(NO, CATEGORY, TITLE, CONTENT) VALUES(YOMUL_FAQ_ARTICLES_NO_SEQ.NEXTVAL, 4, '제목4', '내용114');
INSERT INTO YOMUL_FAQ_ARTICLES(NO, CATEGORY, TITLE, CONTENT) VALUES(YOMUL_FAQ_ARTICLES_NO_SEQ.NEXTVAL, 5, '제목5', '내용115');
INSERT INTO YOMUL_FAQ_ARTICLES(NO, CATEGORY, TITLE, CONTENT) VALUES(YOMUL_FAQ_ARTICLES_NO_SEQ.NEXTVAL, 6, '제목6', '내용116');
INSERT INTO YOMUL_FAQ_ARTICLES(NO, CATEGORY, TITLE, CONTENT) VALUES(YOMUL_FAQ_ARTICLES_NO_SEQ.NEXTVAL, 7, '제목7', '내용117');

-- 공지사항 데이터 생성
INSERT INTO YOMUL_NOTICES(NO, WRITER, TITLE, CONTENT, NDATE) VALUES(YOMUL_NOTICES_NO_SEQ.NEXTVAL, 'M1', '제목1', '내용1', SYSDATE);
INSERT INTO YOMUL_NOTICES(NO, WRITER, TITLE, CONTENT, NDATE) VALUES(YOMUL_NOTICES_NO_SEQ.NEXTVAL, 'M1', '제목2', '내용2', SYSDATE);
INSERT INTO YOMUL_NOTICES(NO, WRITER, TITLE, CONTENT, NDATE) VALUES(YOMUL_NOTICES_NO_SEQ.NEXTVAL, 'M1', '제목3', '내용3', SYSDATE);
