...
CREATE TABLE YOMUL_PRODUCT_CATEGORIES(
  NO NUMBER(5),
  CONTENT VARCHAR2(100) CONSTRAINT NN_Y_PC_CONTENT NOT NULL CONSTRAINT U_Y_PC_CONTENT UNIQUE,
...
CREATE TABLE YOMUL_VENDOR_NEWS(
    ...
    CONSTRAINT FK_Y_VN_VENDOR_NO FOREIGN KEY (VENDOR_NO) REFERENCES YOMUL_VENDORS(NO) ON DELETE CASCADE
);
