...
CREATE TABLE YOMUL_FAVORITE_LISTS(
  ...
  CONSTRAINT FK_Y_FL_P_NO FOREIGN KEY (NO) REFERENCES YOMUL_PRODUCTS(NO)
);
...
CREATE TABLE YOMUL_PRODUCTS(
    ...
    HITS NUMBER(10) DEFAULT 0 CONSTRAINT NN_Y_P_HITS, -- 조회수
...
CREATE TABLE YOMUL_TOWN_ARTICLES(
    ...
    HITS NUMBER(10) DEFAULT 0 CONSTRAINT NN_Y_TA_HITS, -- 조회수
    REPORTS NUMBER(10) DEFAULT 0 CONSTRAINT NN_Y_TA_REPORTS, -- 신고수 
...
CREATE TABLE YOMUL_NEAR_ARTICLES(
    ...
    HITS NUMBER(10) DEFAULT 0 CONSTRAINT NN_Y_NA_HITS, -- 조회수
...
CREATE TABLE YOMUL_NOTICES(
    ...
    HITS NUMBER(10) DEFAULT 0 CONSTRAINT NN_Y_N_HITS, -- 조회수
...
CREATE TABLE YOMUL_FAQ_ARTICLES(
    ...
    HITS NUMBER(10) DEFAULT 0 CONSTRAINT NN_Y_FA_HITS, -- 조회수
...
CREATE TABLE YOMUL_QNA_ARTICLES(
    ...
    HITS NUMBER(10) DEFAULT 0 CONSTRAINT NN_Y_QA_HITS, -- 조회수
