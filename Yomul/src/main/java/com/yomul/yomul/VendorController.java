...
public class VendorController {
	...
	public ModelAndView vendor_profile_info(HttpSession session) {
		ModelAndView mv = new ModelAndView("user/near/vendor_profile_info");
		MemberVO member = (MemberVO) session.getAttribute("member");
	...
	public ModelAndView vendor_news_write_proc(NearVO vo, @RequestParam("profile_img") List<MultipartFile> filelist, HttpServletRequest request,
			HttpSession session) {
		String url = "";
