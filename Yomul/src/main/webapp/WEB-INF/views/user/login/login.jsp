		...
		<div class="container mt-4" style="width: 500px;">
			...
			<form id="form_login" action="login_proc" method="post">
				<div class="form-group h-100 align-middle">
					<input class="w-100 form-control rounded-0" style="border-radius: .25rem .25rem 0 0 !important;" type="email" id="email" name="email" placeholder="이메일" value="${idStore}" required>
					<input class="w-100 form-control rounded-0 border-top-0" style="border-radius: 0 0 .25rem .25rem !important;" type="password" id="pw" name="pw" placeholder="비밀번호" value="${autoLogin}" required>
				</div>
