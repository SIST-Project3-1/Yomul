...
<body>
	...
	<div id="near_home" class="near-home-content">
		...
		<div class="near-home-search">
			<form class="form-inline ml-auto" id="searchForm" method="GET"
				action="near_card_form?word=${word }">
				...
				<div class="input-group flex-nowrap">
					<input class="form-control mr-sm-2 pl-4" type="search"
						placeholder="주변 가게를 찾아보세요" size="60" id="searchInput" name="word"
						value="${word }">
				</div>
			</form>
		</div>
		...
		<div class="near-home-neighbor">
			...
			<div class="near-home-neighbor-content">
				<div>
					<img src="http://localhost:9000/yomul/image/이미지준비중.jpg"> <a
						href="/yomul/vendor_profile_info">업체명입니다</a>
				</div>
				<div>
					<p>정보입니다정보입니다정보입니다정보입니다정보입니다정보입니다...</p>
					<label>후기 5</label> <label>·</label> <label style="color: gray">단골
						10</label>
				</div>
