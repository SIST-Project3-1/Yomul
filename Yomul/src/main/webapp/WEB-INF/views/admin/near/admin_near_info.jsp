	...
	<div id="near_info" class="near-info-content">
		<div class="near-info-left">
			...
			<div class="near-info-left-content">
				<p>${near.content }</p>
				<div>
					<label>${near.ndate }</label>
					<label class="near-info-point">·</label>
					<label>조회 ${near.hits }</label>
					<label class="near-info-point">·</label>
				</div>
			</div>
				...
				<div class="near-info-chat-writer">
					...
					<div>
						...
						<div class="near-info-chat-button">
							<button class="comment-feed__form__submit" type="submit">등록</button>
						</div>
					</div>
				</div>
				<div class="near-info-chat-content">
					...
					<div>
						...
						<div>
							<div>
								<label>작성자</label>
								<span>댓글입니다댓글입니다댓글입니다댓글입니다댓글입니다댓글입니다댓글입니다댓글입니다댓글입니다댓글입니다 댓글입니다댓글입니다댓글입니다댓글입니다댓글입니다댓글입니다댓글입니다댓글입니다댓글입니다댓글입니다댓글입니다</span>
							</div>
							<div>
								<label>1시간 전</label>
								<label class="near-info-point">·</label>
		...
		<div class="near-info-right">
			<div class="near-info-right-writer">
				<img src="/yomul/image/이미지준비중.jpg">
				<label>${near.writer }</label>
				<a class="btn btn-light ml-5">회원정보</a>
			</div>
			<div class="near-info-right-price">
				<label>가격</label>
				<label>${near.price}원</label>
			</div>
